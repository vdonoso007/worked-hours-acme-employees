 ...
 * @final
 */
class srcIOET_Apps_Acme_PayRoll_v1_Employee_PayRollKernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            include_once \dirname(__DIR__, 4).'/src/PayRollKernel.php';
        };
    }
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/srcIOET_Apps_Acme_PayRoll_v1_Employee_PayRollKernelDevDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                'FrameworkBundle' => [
                    'path' => '/Users/victor/Documents/Learning/Worked-Hours-Acme-Employees-MySolution/vendor/symfony/framework-bundle',
                    'namespace' => 'Symfony\\Bundle\\FrameworkBundle',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'srcIOET_Apps_Acme_PayRoll_v1_Employee_PayRollKernelDevDebugContainer',
            ...
            'router.cache_class_prefix' => 'srcIOET_Apps_Acme_PayRoll_v1_Employee_PayRollKernelDevDebugContainer',
